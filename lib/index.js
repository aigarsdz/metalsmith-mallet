  ...
  return function (files, metalsmith, done) {
    ...
    Object.keys(files).forEach(function (file) {
      ...
      if (isJekyllStylePost(file)) {
        ...
        data.url  = '/' + dir + '/' + parts.name; // Set the URL for the post.
        ...
        // Make it easier to work with metalsmith-collections plugin by
        // specifying a collection property based on the template name.
